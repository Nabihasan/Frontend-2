      ...
      {tickets.map((ticket) => (
        ...
        <div className="card-body" key={ticket.ticketId}>
          <form onSubmit={handleSubmit}>
            ...
            {(updatedTicket.status==="Solved" || updatedTicket.status==="Closed") &&(
            <div className="row mb-3">
                <label htmlFor="disabledTextInput"  className="col-sm-2 col-form-label">Solution :</label>
                <div className="col-sm-10">
                  <textarea name='solution' row="3" type="text" disabled= {ticket.status==="Closed"} className="form-control" 
            ...
            {updatedTicket.status==="Closed" && (
              ...
              <div className="col-sm-10">
                <input name='feedback' type="text" disabled= {ticket.status==="Closed"} className="form-control" 
            ...
            <div className="row">
              <div className="col-sm-10 offset-sm-2">
                <button disabled= {ticket.status==="Closed"} type="submit" className="btn btn-primary">Update</button>
              </div>
            </div>
          </form>
        </div>
