...
const SearchFilter = ({ updateTickets, clearSearch }) => {
  ...
  const handleSearch = async () => {
    if (ticketId) {
      ...
      try {
        const response = await TicketService.getTicketByIdForUser(ticketId);
  ...
  const handleApplyFilters = async () => {
    ...
    try {
      const response = await TicketService.getTicketsForUser(queryString);
          ...
          >
            <div className="card-body">
              ...
              <div className="form-group">
                ...
                >
                  <option value="raiseDate" defaultChecked>
                    RaisedDate
                  </option>
